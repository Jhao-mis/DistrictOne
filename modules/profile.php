                    ...
                    <div class="card mb-6" style="margin-bottom:20px;">
                        ...
                        <div class="card-body">
                            <small class="card-text text-uppercase text-body-secondary small"
                                style="font-size:15px;"><strong>About</strong></small>
                            <ul class="list-unstyled my-3 py-1">
                                <li class="d-flex align-items-center mb-4"><i class="icon-base bx bx-user"></i><span
                                        class="fw-medium mx-2"><strong>Full Name:</strong></span>
                                ...
                                <li class="d-flex align-items-center mb-4"><i class="fa fa-birthday-cake"></i><span
                                        class="fw-medium mx-2"><strong>Birthday:</strong></span>
                                ...
                                <li class="d-flex align-items-center mb-4"><i class="icon-base bx bx-flag"></i><span
                                        class="fw-medium mx-2"><strong>Citizenship:</strong></span>
                                    <span><?php echo htmlspecialchars($citizenship); ?></span>
                                </li>
                            </ul>
                            <small class="card-text text-uppercase text-body-secondary small"
                                style="font-size:15px;"><strong><strong>Contacts</strong></strong></small>
                            <ul class="list-unstyled my-3 py-1">
                                <li class="d-flex align-items-center mb-4"><i class="icon-base bx bx-phone"></i><span
                                        class="fw-medium mx-2"><strong>Telephone:</strong></span>
                                ...
                                <li class="d-flex align-items-center mb-4"><i class="icon-base bx bx-chat"></i><span
                                        class="fw-medium mx-2"><strong>Mobile:</strong></span>
                                ...
                                <li class="d-flex align-items-center mb-4"><i class="icon-base bx bx-envelope"></i><span
                                        class="fw-medium mx-2"><strong>Email:</strong></span>
                                    <span><?php echo htmlspecialchars($email); ?></span>
                                </li>
                            </ul>
                            <small class="card-text text-uppercase text-body-secondary small"
                                style="font-size:15px;"><strong>Educational Background</strong></small>
                            <ul class="list-unstyled my-3 py-1">
                                <li class="d-flex align-items-center mb-4"></i><span
                                        class="fw-medium mx-2"><strong>Elementary:</strong></span>
                                    <span><?php echo htmlspecialchars($elementarySchool); ?> </span>
                                </li>
                                <li class="d-flex align-items-center mb-4"></i><span
                                        class="fw-medium mx-2"><strong>Highshool</strong>:</span>
                                    <span><?php echo htmlspecialchars($highSchool); ?> </span>
                                </li>
                                <li class="d-flex align-items-center mb-4"></i><span
                                        class="fw-medium mx-2"><strong>College:</strong></span>
                                    <span><?php echo htmlspecialchars($college); ?></span>
                                </li>
                                <li class="d-flex align-items-center mb-4"></i><span class="fw-medium mx-2"><strong>
                                            Graduate School:</strong></span>
                                    <span><?php echo htmlspecialchars($graduateSchool); ?> </span>
                                </li>
                                <li class="d-flex align-items-center mb-4"></i><span
                                        class="fw-medium mx-2"><strong>Vocational Course:</strong></span>
                                    <span><?php echo htmlspecialchars($vocTradeCourse); ?></span>
                                </li>
                            </ul>
                            <small class="card-text text-uppercase text-body-secondary small"
                                style="font-size:15px;"><strong><strong>Family Members</strong></strong></small>
                            <ul class="list-unstyled my-3 py-1">
                                <li class="d-flex align-items-center mb-4"></i><span
                                        class="fw-medium mx-2"><strong>Spouse:</strong></span>
                                ...
                                <li class="d-flex align-items-center mb-4"></i><span
                                        class="fw-medium mx-2"><strong>Mother:</strong></span>
                                ...
                                <li class="d-flex align-items-center mb-4"></i><span
                                        class="fw-medium mx-2"><strong>Father:</strong></span>
