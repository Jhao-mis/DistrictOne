                            ...
                            <div class="offcanvas-body">
                                ...
                                <form method="POST" class="reservation-form">
                                    ...
                                    <select name="room" class="form-select" required>
                                        ...
                                        <option value="Training Room, 3rd Floor, CWD Main Building">
                                            Training Room, 3rd Floor, CWD Main Building
                                        </option>
                                        <option value="Multipurpose Hall 5th Floor CWD Main Building">
                                            Multipurpose Hall 5th Floor CWD Main Building
                                        </option>
                                        <option value="Conference Room, 2nd Floor, CWD Warehouse">
                                            Conference Room, 2nd Floor, CWD Warehouse
                                        </option>
                                        <option value="Conference Room, Operations Building, BPS Upper">
                                            Conference Room, Operations Building, BPS Upper
                                        </option>
                                        <option value="Roof Deck, Operations Building, BPS Upper">
                                            Roof Deck, Operations Building, BPS Upper
                                        </option>
                                    </select>
                ...
                fetch('roomReservation.php', {
                    ...
                    .then(reservedRooms => {
                        ...
                        Array.from(roomSelect.options).forEach(option => {
                            ...
                            if (isReserved) {
                                option.textContent = roomName + ' (Not Available)';
                                option.style.color = 'red';
                            } else {
                                option.textContent = roomName.replace(' (Not Available)', '');
                                option.style.color = '';
                            }
