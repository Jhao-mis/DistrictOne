...
/* Section header (splits general items from MIS tools) */
  ...
  <div class="layout-container">
    ...
    <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
      ...
      <ul class="menu-inner py-1">
        ...
        <?php if (access_can('module.calendar')): ?><li class="menu-item"><a href="../modules/calendar.php" class="menu-link"><div>Calendar Activity</div></a></li><?php endif; ?>
        ...
        <!-- MIS Tools -->
        <?php if (access_can_any(['mis.ticket_assignment', 'mis.machine_inspection'])): ?><li class="menu-header"><span>MIS Access</span></li>

        <?php if (access_can('mis.ticket_assignment')): ?><li class="menu-item <?= $currentPage=='ticketAssign.php' ? 'active' : '' ?>">
          <a href="../mis/ticketAssign.php" class="menu-link">
            <i class="menu-icon tf-icons bx bx-task"></i>
            <div>Ticket Assignment</div>
            <?php if ($assignedTicketCount > 0): ?><span class="sb-pill is-blue"><?= $assignedTicketCount ?></span><?php endif; ?>
          </a>
        </li><?php endif; ?>

        <?php if (access_can('mis.machine_inspection')): ?><li class="menu-item <?= $currentPage=='mir.php' ? 'active' : '' ?>">
          <a href="../mis/mir.php" class="menu-link">
            <i class="menu-icon tf-icons bx bx-wrench"></i>
            <div>Machine Inspection Report</div>
          </a>
        </li><?php endif; ?>
        <?php endif; ?>
