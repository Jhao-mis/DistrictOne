...
<head>
  ...
  <style>
    ...
    .profile-slide {
      display: none;
      min-height: 450px;
      /* Adjust based on your tallest slide */
      align-items: center;
      justify-content: center;
      flex-wrap: wrap;
      padding: 20px;
...
<body>
  ...
  <section class="w-100 text-center text-white py-5 m-0 mb-5"
    style="background: url('assets/img/backgrounds/districtOnebg.png') no-repeat center center / cover;">
    <div class="w-100">
      <h1 class="display-4 fw-bold">About DistrictOne</h1>
      <p class="lead mt-3" style="text-align: center;">Learn more about the DistrictOne and the team behind its
        development.
      </p>
  ...
  <div class="text-center mt-5 mb-5 py-3">
    <a href="login.php" class="btn btn-outline-primary px-4 py-2 rounded-pill shadow-sm">
      ← Back to Login
    </a>
  </div>
