...
require 'db_admin_datasheet.php';
...
>
  <head>
    ...
    <title>Personal Data Sheet - District One</title>
...
.custom-outline-blue2:hover {
    background-color: #007bff; /* Blue background on hover */
    color: white; /* White text on hover */
}
.custom-outline-blue3 {
    background-color: white;
    color: #007bff; /* Blue text */
    border: 2px solid #007bff; /* Blue border */
    padding: 8px 16px;
...
.custom-outline-blue3:hover {
    background-color: #007bff; /* Blue background on hover */
    color: white; /* White text on hover */
}
.custom-outline-blue4 {
    background-color: white;
    color: #007bff; /* Blue text */
    border: 2px solid #007bff; /* Blue border */
    padding: 8px 16px;
...
.custom-outline-blue4:hover {
    background-color: #007bff; /* Blue background on hover */
    color: white; /* White text on hover */
}
.custom-outline-blue5 {
    background-color: white;
    color: #007bff; /* Blue text */
    border: 2px solid #007bff; /* Blue border */
    padding: 8px 16px;
...
.custom-outline-blue5:hover {
    background-color: #007bff; /* Blue background on hover */
    color: white; /* White text on hover */
}
.custom-outline-blue6 {
    background-color: white;
    color: #007bff; /* Blue text */
    border: 2px solid #007bff; /* Blue border */
    padding: 8px 16px;
...
.custom-outline-blue6:hover {
    background-color: #007bff; /* Blue background on hover */
    color: white; /* White text on hover */
}
.custom-outline-blue7 {
    background-color: white;
    color: #007bff; /* Blue text */
    border: 2px solid #007bff; /* Blue border */
    padding: 8px 16px;
    ...
    <?php include 'sidebar.php' ?>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Account /</span> Personal Sheet</h4>
              ...
              <div class="row">
                <div class="col-md-12">
                  ...
                  <div class="card mb-4">
                    ...
                    <hr class="my-0" />
                    <div class="card-body">
                      <form method="POST" id ="dataForm" action="super_admin_datasheet.php">
                        <div class="row">
                    ...
                    <input class="form-control" type="text" name="name_extension" placeholder="JR/SR"
                        value="<?= htmlspecialchars($user_data['name_extension'] ?? '') ?>">
                </div>

                <div class="mb-3 col-md-6">
                    <label for="department" class="form-label">Department</label>
                    <input class="form-control" type="text" name="department" id="department" autofocus value="<?php echo htmlspecialchars($department); ?>" readonly/>
                </div>
...
<div class="mb-3 col-md-6">
    ...
    <select id="employeeSalaryGrade" name="employeeSalaryGrade" class="select2 form-select">
...
<div class="mb-3 col-md-6">
    ...
    <select id="sgStep" name="sgStep" class="select2 form-select">
        <option value="" disabled <?= empty($sgStep) ? 'selected' : ''; ?>>Select Step</option>
        <?php for ($i = 1; $i <= 8; $i++): ?>
            <option value="<?= $i ?>" <?= ($sgStep == (string)$i) ? 'selected' : ''; ?>><?= $i ?></option>
        <?php endfor; ?>
    </select>
</div>
...
<div class="mb-3 col-md-6">
    ...
    <input class="form-control" type="number" id="salary" name="salary" value="<?= htmlspecialchars($user_data['salary'] ?? '') ?>" readonly>
        ...
        if (year.length !== 4) {
            ...
            input.value = '';
                  ...
                  <div class="mb-3 col-md-6">
                    ...
                    <input class="form-control" type="text" name="place_of_birth" placeholder="Input your place of birth"
    ...
    <select id="sex" name="sex" class="select2 form-select">
        ...
        <option value="Female" <?= ($sex == 'Female') ? 'selected' : ''; ?>>Female</option>
                       ...
                       <div class="mb-3 col-md-6">
                        ...
                        <input class="form-control" type="text" name="height" placeholder="Height in meters"
                        value="<?= htmlspecialchars($user_data['height'] ?? '') ?>">
                        </div>

                          <div class="mb-3 col-md-6">
                        <label for="weight" class="form-label">Weight</label>
                        <input class="form-control" type="text" name="weight" placeholder="Weight in Kilograms"
                        ...
                        <input class="form-control" type="text" name="gsis_id_no" placeholder="Input your GSIS ID number"
                        value="<?= htmlspecialchars($user_data['gsis_id_no'] ?? '') ?>">
                        </div>

                           <div class="mb-3 col-md-6">
                        <label for="pagibig_id_no" class="form-label">PAG-IBIG ID NO.</label>
                        <input class="form-control" type="text" name="pagibig_id_no" placeholder="Input your PagIbig ID number"
                        value="<?= htmlspecialchars($user_data['pagibig_id_no'] ?? '') ?>">
                        </div>
                          <div class="mb-3 col-md-6">
                        <label for="philhealth_no" class="form-label">PHILHEALTH NO.</label>
                        <input class="form-control" type="text" name="philhealth_no" placeholder="Input your PhilHealth number"
                        value="<?= htmlspecialchars($user_data['philhealth_no'] ?? '') ?>">
                        </div>
                          <div class="mb-3 col-md-6">
                        <label for="sss_no" class="form-label">SSS NO.</label>
                        <input class="form-control" type="text" name="sss_no" placeholder="Input your SSS number"
                        value="<?= htmlspecialchars($user_data['sss_no'] ?? '') ?>">
                        </div>
                          <div class="mb-3 col-md-6">
                        <label for="tin_no" class="form-label">TIN  NO.</label>
                        <input class="form-control" type="text" name="tin_no" placeholder="Input your TIN number"
                        value="<?= htmlspecialchars($user_data['tin_no'] ?? '') ?>">
                        </div>
                          <div class="mb-3 col-md-6">
                        <label for="agency_employee_no" class="form-label">AGENCY EMPLOYEE NO.</label>
                        <input class="form-control" type="text" name="agency_employee_no" placeholder="Input your Agency Employee number"
                        value="<?= htmlspecialchars($user_data['agency_employee_no'] ?? '') ?>">
                        </div>

                          <div class="mb-3 col-md-6">
                        <label for="citizenship" class="form-label">Citizenship</label>
                        <select class="select2 form-select"  id="citizenship" name="citizenship" onchange="toggleCitizenshipFields()">
                            <option value="" disabled <?= empty($citizenship) ? 'selected' : ''; ?>>Citizenship</option>
                            <option value="Filipino" <?= ($citizenship == 'Filipino') ? 'selected' : ''; ?>>Filipino</option>
                            <option value="Dual" <?= ($citizenship == 'Dual') ? 'selected' : ''; ?>>Dual</option>
                        ...
                        <label for="dual_holder" class="form-label">If holder of Dual Citizenship, please indicate details</label>
                        <input class="form-control" type="text" id="dual_holder" name="dual_holder" placeholder="Specify your Other Citizenship" value="<?= htmlspecialchars($user_data['dual_holder'] ?? '') ?>" />
                        </div>
                      ...
                      document.addEventListener("DOMContentLoaded", function() {
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <label for="RA_house_block_lot_no" class="form-label">House Block Lot No.</label>
                            <input class="form-control" type="text" id="RA_house_block_lot_no" name="RA_house_block_lot_no" placeholder="House Block Lot No."
                             value="<?= htmlspecialchars($user_data['RA_house_block_lot_no'] ?? '') ?>">

                          </div>
                          <div class="mb-3 col-md-6">
                          <label for="RA_subdivision_village" class="form-label">Residential Address || </label>
                            <label for="RA_subdivision_village" class="form-label">Subdivision/Village</label>
                            <input class="form-control" type="text" id="RA_subdivision_village" name="RA_subdivision_village" placeholder="Subdivision/Village"
                            value="<?= htmlspecialchars($user_data['RA_subdivision_village'] ?? '') ?>">
                          </div>

                          <div class="mb-3 col-md-6">
                            <label for="RA_city_municipality" class="form-label">Residential Address || City/Municipality Address</label>
                            <input class="form-control" type="text" id="RA_city_municipality" name="RA_city_municipality" placeholder="City/Municipality"
                          ...
                          <div class="mb-3 col-md-6">
                            ...
                            <input class="form-control" type="text" id="RA_street" name="RA_street" placeholder="Street"
                             value="<?= htmlspecialchars($user_data['RA_street'] ?? '') ?>">
                          </div>
                          <div class="mb-3 col-md-6">
                            <label for="RA_barangay" class="form-label">Residential Address || Barangay</label>
                            <input class="form-control" type="text" id="RA_barangay" name="RA_barangay" placeholder="Barangay"
                            value="<?= htmlspecialchars($user_data['RA_barangay'] ?? '') ?>">
                          </div>
                          <div class="mb-3 col-md-6">
                            <label for="RA_province" class="form-label">Residential Address || Province</label>
                            <input class="form-control" type="text" id="RA_province" name="RA_province" placeholder="Province"
                            value="<?= htmlspecialchars($user_data['RA_province'] ?? '') ?>">
                          </div>
                          <div class="mb-3 col-md-6">
                            <label for="RA_zip_code" class="form-label">Residential Address || ZIP CODE</label>
                            <input class="form-control" type="text" id="RA_zip_code" name="RA_zip_code" placeholder="ZIP CODE"
                            value="<?= htmlspecialchars($user_data['RA_zip_code'] ?? '') ?>">
                          </div>

                          <div class="mb-3 col-md-6">
                            <label for="PA_house_block_lot_no" class="form-label">Permanent Address || </label>
                            <label for="PA_house_block_lot_no" class="form-label">House Block Lot No.</label>
                            <input class="form-control" type="text" id="PA_house_block_lot_no" name="PA_house_block_lot_no" placeholder="House Block Lot No."
                            value="<?= htmlspecialchars($user_data['PA_house_block_lot_no'] ?? '') ?>">
                          </div>

                          <div class="mb-3 col-md-6">
                          <label for="PA_subdivision_village" class="form-label">Permanent Address || </label>
                            <label for="PA_subdivision_village" class="form-label">Subdivision/Village</label>
                            <input class="form-control" type="text" id="PA_subdivision_village" name="PA_subdivision_village" placeholder="Subdivision/Village"
                            value="<?= htmlspecialchars($user_data['PA_subdivision_village'] ?? '') ?>">
                          </div>

                          <div class="mb-3 col-md-6">
                            <label for="PA_city_municipality" class="form-label">Permanent Address || City/Municipality Address</label>
                            <input class="form-control" type="text" id="PA_city_municipality" name="PA_city_municipality" placeholder="City/Municipality"
                            value="<?= htmlspecialchars($user_data['PA_city_municipality'] ?? '') ?>">
                          </div>

                          <div class="mb-3 col-md-6">
                            <label for="PA_street" class="form-label">Permanent Address || Street</label>
                            <input class="form-control" type="text" id="PA_street" name="PA_street" placeholder="Street"
                            value="<?= htmlspecialchars($user_data['PA_street'] ?? '') ?>">

                          </div>
                          <div class="mb-3 col-md-6">
                            <label for="PA_barangay" class="form-label">Permanent Address || Barangay</label>
                            <input class="form-control" type="text" id="PA_barangay" name="PA_barangay" placeholder="Barangay"
                            value="<?= htmlspecialchars($user_data['PA_barangay'] ?? '') ?>">
                          </div>

                          <div class="mb-3 col-md-6">
                            <label for="PA_province" class="form-label">Permanent Address || Province</label>
                            <input class="form-control" type="text" id="PA_province" name="PA_province" placeholder="Province"
                             value="<?= htmlspecialchars($user_data['PA_province'] ?? '') ?>">
                          </div>

                          <div class="mb-3 col-md-6">
                            <label for="PA_zip_code" class="form-label">Permanent Address || ZIP CODE</label>
                            <input class="form-control" type="text" id="PA_zip_code" name="PA_zip_code" placeholder="ZIP CODE"
                             value="<?= htmlspecialchars($user_data['PA_zip_code'] ?? '') ?>">
                          </div>

                          <div class="mb-3 col-md-6">
                            <label for="telephone_no" class="form-label">Telephone No.</label>
                            <input class="form-control" type="text" id="telephone_no" name="telephone_no" autofocus placeholder="Input your Telephone Number"
                          ...
                          <div class="mb-3 col-md-6">
                            ...
                            <input class="form-control" type="text" id="mobile_no" name="mobile_no" placeholder="Input your Mobile Number"
                            value="<?= htmlspecialchars($user_data['mobile_no'] ?? '') ?>">
                          </div>
                          <div class="mb-3 col-md-6">
                            <label for="email" class="form-label">Email Address</label>
                            <input class="form-control" type="text" id="email" name="email"  value="<?php echo htmlspecialchars($email); ?>" readonly/>
                          </div>
                          ...
                          <div class="mb-3 col-md-6">
                            ...
                            <input
                              ...
                              placeholder="Input your Spouse's First Name"
                              autofocus
                              value="<?= htmlspecialchars($family_data['spouse_first_name'] ?? '') ?>">                      
                          </div>

                          <div class="mb-3 col-md-6">
                            <label for="spouse_extension_name" class="form-label">Name Extension (If applicable)</label>
                            <input
                              class="form-control"
                              type="text"
                          ...
                          <div class="mb-3 col-md-6">
                            ...
                            <input
                              ...
                              placeholder="Input your Spouse's Last Name"
                              autofocus
                          ...
                          <div class="mb-3 col-md-6">
                            <label for="spouse_employer_business_name" class="form-label">Spouse's Employer/Business Name</label>
                            <input
                              class="form-control"
                              type="text"
                          ...
                          <div class="mb-3 col-md-6">
                            <label for="spouse_business_address" class="form-label">Spouse's Business Address</label>
                            <input
                              class="form-control"
                              type="text"
                          ...
                          <div class="mb-3 col-md-6">
                            <label for="spouse_telephone_no" class="form-label"> Spouse's Telephone No.</label>
                            <input
                              class="form-control"
                              type="text"
                          ...
                          <div class="mb-3 col-md-6">
                            <label for="father_name_extension" class="form-label">Name Extension (If applicable)</label>
                            <input
                              class="form-control"
                              type="text"
                          ...
                          <div class="mb-3 col-md-6">
                            ...
                            <input
                              ...
                              placeholder="Input your Father's Last Name"
                              autofocus
                          ...
                          <div class="mb-3 col-md-6">
                            ...
                            <input
                              ...
                              placeholder="Input your Mother's Last Name"
                              autofocus
      ...
      for ($i = 0; $i < $totalChildren; $i++): ?>
            <div class="child-entry">
                <div class="mb-3 col-md-12">
                     <label for="child<?= $i + 1 ?>" class="form-label">Name of Child <?= $i + 1 ?></label>
                    <input class="form-control" type="text" id="child<?= $i + 1 ?>FullName" name="children[]" placeholder="Input Child <?= $i + 1 ?>'s Full Name" value="<?= isset($_SESSION['children'][$i]) ? htmlspecialchars($_SESSION['children'][$i], ENT_QUOTES) : ''; ?>"/>
                </div>
                <div class="mb-3 col-md-12">
                    <label for="birthdate<?= $i + 1 ?>" class="form-label">Date of Birth</label>
                    <input class="form-control" type="date" id="birthdate<?= $i + 1 ?>" name="birthdate[]" maxlength="10" pattern="\d{4}-\d{2}-\d{2}" 
        ...
        container.appendChild(childDiv);
                     ...
                     <!-- Educational Background -->
                      ...
                      <h4>III. Educational Background</h4>
                        ...
                        <input class="form-control" type="text" id="elementarySchool" name="elementarySchool" placeholder="Input your Elementary School" autofocus                              
                        value="<?= htmlspecialchars($education_data['elementarySchool'] ?? '') ?>">
                        </div>

                        <div class="mb-3 col-md-6">
                        <label for="basicEd" class="form-label">Basic Education</label>
                        <input class="form-control" type="text" id="basicEd" name="basicEd" placeholder="Input your Basic Education" autofocus
                        ...
                        <input class="form-control" type="text" id="From_1" name="From_1" placeholder="Input your Period of Attendance(From)" autofocus
                        ...
                        <input class="form-control" type="text" id="To_1" name="To_1" placeholder="Input your Period of Attendace(To)" autofocus
                        ...
                        <input class="form-control" type="text" id="elementaryYearGraduated" name="elementaryYearGraduated" placeholder="YYYY" autofocus
                        value="<?= htmlspecialchars($education_data['elementaryYearGraduated'] ?? '') ?>">

                        </div>

                        <div class="mb-3 col-md-6">
                        <label for="LevelUnitsEarned" class="form-label">Highest Level/Units Earned(If not Graduated)</label>
                        <input class="form-control" type="text" id="LevelUnitsEarned" name="LevelUnitsEarned" placeholder="Input your Highest Level or Units Earned" autofocus
                        value="<?= htmlspecialchars($education_data['LevelUnitsEarned'] ?? '') ?>">
                        </div>

                         <div class="mb-3 col-md-6">
                        <label for="scholar_honors" class="form-label">Scholarship/Academic Honors</label>
                        <input class="form-control" type="text" id="scholar_honors" name="scholar_honors" placeholder="Input your Scholarship/Academic Honors" autofocus
                        ...
                        <label for="highSchool" class="form-label">High School</label>
                         <input class="form-control" type="text" id="highSchool" name="highSchool" placeholder="Input your High School" autofocus                              
                         value="<?= htmlspecialchars($education_data['highSchool'] ?? '') ?>">
                        </div>

                        <div class="mb-3 col-md-6">
                        <label for="basicEd2" class="form-label">Basic Education</label>
                        <input class="form-control" type="text" id="basicEd2" name="basicEd2" placeholder="Input your Basic Education" autofocus
                        value="<?= htmlspecialchars($education_data['basicEd2'] ?? '') ?>">
                        </div>

                         <div class="mb-3 col-md-6">
                        <label for="From_2" class="form-label">From</label>
                        <input class="form-control" type="text" id="From_2" name="From_2" placeholder="Input your Period of Attendance(From)" autofocus
                        ...
                        <input class="form-control" type="text" id="To_2" name="To_2" placeholder="Input your Period of Attendace(To)" autofocus
                        ...
                        <input class="form-control" type="text" id="highSchoolYearGraduated" name="highSchoolYearGraduated" placeholder="YYYY" autofocus
                        value="<?= htmlspecialchars($education_data['highSchoolYearGraduated'] ?? '') ?>">
                        </div>

                        <div class="mb-3 col-md-6">
                        <label for="LevelUnitsEarned2" class="form-label">Highest Level/Units Earned(If not Graduated)</label>
                        <input class="form-control" type="text" id="LevelUnitsEarned2" name="LevelUnitsEarned2" placeholder="Input your Highest Level or Units Earned" autofocus
                        value="<?= htmlspecialchars($education_data['LevelUnitsEarned2'] ?? '') ?>">
                        </div>

                           
                         <div class="mb-3 col-md-6">
                        <label for="scholar_honors2" class="form-label">Scholarship/Academic Honors</label>
                        <input class="form-control" type="text" id="scholar_honors2" name="scholar_honors2" placeholder="Input your Scholarship/Academic Honors" autofocus
                        ...
                        <input class="form-control" type="text" id="college" name="college" placeholder="Input your College/University" autofocus
                        value="<?= htmlspecialchars($education_data['college'] ?? '') ?>">
                        </div>

                        <div class="mb-3 col-md-6">
                        <label for="collegeDegree" class="form-label">Degree</label>
                        <input class="form-control" type="text" id="collegeDegree" name="collegeDegree" placeholder="Input your Degree" autofocus
                        ...
                        <input class="form-control" type="text" id="From_3" name="From_3" placeholder="Input your Period of Attendance(From)" autofocus
                        ...
                        <input class="form-control" type="text" id="To_3" name="To_3" placeholder="Input your Period of Attendace(To)" autofocus
                        value="<?= htmlspecialchars($education_data['To_3'] ?? '') ?>">
                        </div>
                       
                        <div class="mb-3 col-md-6">
                        <label for="collegeYearGraduated" class="form-label">Year Graduated</label>
                        <input class="form-control" type="text" id="collegeYearGraduated" name="collegeYearGraduated" placeholder="YYYY" autofocus            
                        value="<?= htmlspecialchars($education_data['collegeYearGraduated'] ?? '') ?>">
                        </div>


                         <div class="mb-3 col-md-6">
                        <label for="LevelUnitsEarned3" class="form-label">Highest Level/Units Earned(If not Graduated)</label>
                        <input class="form-control" type="text" id="LevelUnitsEarned3" name="LevelUnitsEarned3" placeholder="Input your Highest Level or Units Earned" autofocus
                        value="<?= htmlspecialchars($education_data['LevelUnitsEarned3'] ?? '') ?>">
                        </div>

                           
                         <div class="mb-3 col-md-6">
                        <label for="scholar_honors3" class="form-label">Scholarship/Academic Honors</label>
                        <input class="form-control" type="text" id="scholar_honors3" name="scholar_honors3" placeholder="Input your Scholarship/Academic Honors" autofocus
                        ...
                        <div class="mb-3 col-md-6">
                        <label for="vocTradeCourse" class="form-label">Vocational/Trade Course (If applicable)</label>
                        <input class="form-control" type="text" id="vocTradeCourse" name="vocTradeCourse" placeholder="Input your Vocational/Trade Course School" autofocus
                        value="<?= htmlspecialchars($education_data['vocTradeCourse'] ?? '') ?>">
                        </div>

                        <div class="mb-3 col-md-6">
                        <label for="vocTradeDegree" class="form-label">Degree</label>
                        <input class="form-control" type="text" id="vocTradeDegree" name="vocTradeDegree" placeholder="Input your Vocational/Trade Degree" autofocus
                        value="<?= htmlspecialchars($education_data['vocTradeDegree'] ?? '') ?>">
                        </div>

                        <div class="mb-3 col-md-6">
                        <label for="From_4" class="form-label">From</label>
                        <input class="form-control" type="text" id="From_4" name="From_4" placeholder="Input your Period of Attendance(From)" autofocus
                        ...
                        <input class="form-control" type="text" id="To_4" name="To_4" placeholder="Input your Period of Attendace(To)" autofocus
                        ...
                        <input class="form-control" type="text" id="vocTradeGraduated" name="vocTradeGraduated" placeholder="YYYY" autofocus                                
                        value="<?= htmlspecialchars($education_data['vocTradeGraduated'] ?? '') ?>">
                        </div>

                             <div class="mb-3 col-md-6">
                        <label for="LevelUnitsEarned4" class="form-label">Highest Level/Units Earned(If not Graduated)</label>
                        <input class="form-control" type="text" id="LevelUnitsEarned4" name="LevelUnitsEarned4" placeholder="Input your Highest Level or Units Earned" autofocus
                        value="<?= htmlspecialchars($education_data['LevelUnitsEarned4'] ?? '') ?>">
                        </div>

                           
                         <div class="mb-3 col-md-6">
                        <label for="scholar_honors4" class="form-label">Scholarship/Academic Honors</label>
                        <input class="form-control" type="text" id="scholar_honors4" name="scholar_honors4" placeholder="Input your Scholarship/Academic Honors" autofocus
                        ...
                        <hr style="border: 1px solid; width: 100%;">
                              <!--GRADUATE SCHOOL-->
                        <div class="mb-3 col-md-6">
                        <label for="graduateSchool" class="form-label">Graduate School (If applicable)</label>
                        <input class="form-control" type="text" id="graduateSchool" name="graduateSchool" placeholder="Input your Graduate School" autofocus
                        value="<?= htmlspecialchars($education_data['graduateSchool'] ?? '') ?>">
                        </div>

                        <div class="mb-3 col-md-6">
                        <label for="graduateDegree" class="form-label">Degree</label>
                        <input class="form-control" type="text" id="graduateDegree" name="graduateDegree" placeholder="Input your Graduate Degree" autofocus
                        value="<?= htmlspecialchars($education_data['graduateDegree'] ?? '') ?>">
                        </div>

                        <div class="mb-3 col-md-6">
                        <label for="From_5" class="form-label">From</label>
                        <input class="form-control" type="text" id="From_5" name="From_5" placeholder="Input your Period of Attendance(From)" autofocus
                        ...
                        <input class="form-control" type="text" id="To_5" name="To_5" placeholder="Input your Period of Attendace(To)" autofocus
                        value="<?= htmlspecialchars($education_data['To_5'] ?? '') ?>">
                        </div>

                             <div class="mb-3 col-md-6">
                        <label for="LevelUnitsEarned5" class="form-label">Highest Level/Units Earned(If not Graduated)</label>
                        <input class="form-control" type="text" id="LevelUnitsEarned5" name="LevelUnitsEarned5" placeholder="Input your Highest Level or Units Earned" autofocus
                        ...
                        <input class="form-control" type="text" id="graduateYearGraduated" name="graduateYearGraduated" placeholder="YYYY" autofocus
                        value="<?= htmlspecialchars($education_data['graduateYearGraduated'] ?? '') ?>">
                        </div>

                           
                         <div class="mb-3 col-md-6">
                        <label for="scholar_honors5" class="form-label">Scholarship/Academic Honors</label>
                        <input class="form-control" type="text" id="scholar_honors5" name="scholar_honors5" placeholder="Input your Scholarship/Academic Honors" autofocus
...
document.querySelectorAll('input[type="date"]').forEach(input => {
    ...
    <?php endif; ?>
                        ...
                        <button type="button" class="custom-outline-blue2 mt-3" onclick="addEligibilityRow()">+ Add Eligibility</button>
    ...
    input.addEventListener('blur', () => {
        ...
        <?php else: ?>
            ...
            <tr>
                ...
                <td><input type="text" class="form-control" name="we_department[]" placeholder="Department / Company"/></td>
                ...
                <td><input type="text" class="form-control" name="appointment_status[]" placeholder="Status of Appointment"/></td>
                <td>
                    <select class="form-control" name="govt_service[]">
...
document.querySelectorAll('input[type="date"]').forEach(input => {
    input.addEventListener('blur', () => {
        ...
        <?php endif; ?>
                        ...
                        <button type="button" class="custom-outline-blue3 mt-3" onclick="addWorkExperienceRow()">+ Add Work Experience</button>
...
function addWorkExperienceRow() {
    ...
    `;
                        ...
                        <!-- Voluntary Work -->
                        <div class="table-responsive mt-3">  
                        <h4 style="margin-top:20px;">VI. Voluntary Work Or Involvement In Civic / Non-Government / People / Voluntary Organizations</h4>
        ...
        <?php if ($result_voluntary->num_rows > 0): ?>
            <?php while ($row = $result_voluntary->fetch_assoc()): ?>
                <tr>
                    ...
                    <td>
                        <input type="date" class="form-control" name="voluntary_from_date[]"
                            value="<?= htmlspecialchars($row['voluntary_from_date'] ?? '', ENT_QUOTES); ?>" />
                    </td>
                    <td>
                        <input type="date" class="form-control" name="voluntary_to_date[]"
                            value="<?= htmlspecialchars($row['voluntary_to_date'] ?? '', ENT_QUOTES); ?>" />
                    </td>
                    <td>
                        <input type="number" class="form-control" name="voluntary_hours[]"
                            value="<?= htmlspecialchars($row['voluntary_hours'] ?? '', ENT_QUOTES); ?>" />
                    </td>
                    <td>
                        <input type="text" class="form-control" name="voluntary_position[]"
...
document.querySelectorAll('input[type="date"]').forEach(input => {
    input.addEventListener('blur', () => {
        ...
        <button type="button" class="custom-outline-blue4 mt-3" onclick="addVoluntaryWorkRow()">+ Add Voluntary Work</button>
</div>
...
<script>
  ...
  function addVoluntaryWorkRow() {
      ...
      `;
                         ...
                         <div class="table-responsive mt-3">  
<h4 style="margin-top:20px;">VII. Learning and Development (L&D) Interventions/Training Programs Attended</h4>
<div class="mb-3 col-md-12">
        ...
        <tbody>
            <?php if (!empty($learning_development_data)): ?>
                <?php foreach ($learning_development_data as $ld): ?>
                  ...
                  ?>
                    <tr>
                        <td><input type="text" class="form-control" name="training_title[]" value="<?= htmlspecialchars($ld['training_title'], ENT_QUOTES) ?>" /></td>
                        <td><input type="date" class="form-control" name="from_date[]" value="<?= htmlspecialchars($ld['from_date'], ENT_QUOTES) ?>" /></td>
                        <td><input type="date" class="form-control" name="to_date[]" value="<?= htmlspecialchars($ld['to_date'], ENT_QUOTES) ?>" /></td>
                        <td><input type="text" class="form-control" name="hours[]" value="<?= htmlspecialchars($ld['hours'], ENT_QUOTES) ?>" /></td>
                        <td><input type="text" class="form-control" name="type_of_ld[]" value="<?= htmlspecialchars($ld['type_of_ld'], ENT_QUOTES) ?>" /></td>
                        <td><input type="text" class="form-control" name="sponsor[]" value="<?= htmlspecialchars($ld['sponsor'], ENT_QUOTES) ?>" /></td>
                    </tr>
                <?php endforeach; ?>
            <?php else: ?>
                ...
                <tr>
                    ...
                    <td><input type="text" class="form-control" name="hours[]" placeholder="Hours"/></td>
                    <td><input type="text" class="form-control" name="type_of_ld[]" placeholder="Type of LD"/></td>
                    <td><input type="text" class="form-control" name="sponsor[]" placeholder="Conducted By"/></td>
                </tr>
            <?php endif; ?>
        </tbody>
    </table>
...
document.querySelectorAll('input[type="date"]').forEach(input => {
    ...
    <button type="button" class="custom-outline-blue7 mt-3" onclick="addLearningDevelopmentRow()">+ Add Training Program</button>
...
<script>
  ...
  function addLearningDevelopmentRow() {
    ...
    <tr>
    <td>
        <input type="text" class="form-control" name="skillsTitle[]" placeholder="Enter Special Skills and Hobbies"
               value="<?= isset($_SESSION['skillsTitle'][$i]) ? htmlspecialchars($_SESSION['skillsTitle'][$i], ENT_QUOTES) : ''; ?>"/>
    </td>
    <td>
        <input type="text" class="form-control" name="nonAcad[]" placeholder="Non-Academic Distinctions / Hobbies"
               value="<?= isset($_SESSION['nonAcad'][$i]) ? htmlspecialchars($_SESSION['nonAcad'][$i], ENT_QUOTES) : ''; ?>"/>
    </td>
    <td>
        <input type="text" class="form-control" name="membership[]"  placeholder="Membership in Association / Organization"
...
<?php endfor; ?>
        ...
        <button type="button" class="custom-outline-blue6 mt-3" onclick="addOtherInfoCountRow()">+ Add Skills</button>
    </div>
...
<div class="mb-3" id="Details_2" style="display: none;">
    <input type="text" id="details2" name="details2" class="form-control mt-2" placeholder="Provide details"
...
<div class="mb-3" id="Details_3" style="display: none;">
    <input type="text" id="details3" name="details3" class="form-control mt-2" placeholder="Provide details"
...
<div class="mb-3">
    ...
    <option value="No" <?= ($q4 == 'No') ? 'selected' : ''; ?>>No</option>
        ...
        <input type="date" id="details4" name="details4" class="form-control mt-2" placeholder="Date Filed"
        value="<?= htmlspecialchars($details4) ?>" />
    <input type="text" id="details41" name="details41" class="form-control mt-2" placeholder="Status of Case/s"
...
document.addEventListener("DOMContentLoaded", function() {
    toggleDetails4();
                            ...
                            <div class="mb-3">
 <label class="form-label">Have you ever been convicted of any crime or violation of any law, decree, ordinance or regulation by any court or tribunal?</label>
 <select class="form-select" id="q5" name="q5" onchange="toggleDetails5()">
    ...
    <input type="text" id="details5" name="details5" class="form-control mt-2" placeholder="Provide details"
...
document.addEventListener("DOMContentLoaded", function() {
    toggleDetails5();
                            ...
                            <div class="mb-3">
 <label class="form-label">Have you ever been seperated from the service in any of the following modes: resignation, retirement, dropped from the rolls,
                                dismissal, termination, end of term, finished contract or phased out (abolition) in the public or private sector?</label>
    ...
    <input type="text" id="details6" name="details6" class="form-control mt-2" placeholder="Provide details"
...
document.addEventListener("DOMContentLoaded", function() {
    toggleDetails6();
                   ...
                   <div class="mb-3">
 <label class="form-label">Have you ever been a candidate in a national or local election held within last year (except Barangay Election)?</label>
 <select class="form-select" id="q7" name="q7" onchange="toggleDetails7()">
    ...
    <input type="text" id="details7" name="details7" class="form-control mt-2" placeholder="Provide details"
...
document.addEventListener("DOMContentLoaded", function() {
    toggleDetails7();
           ...
           <div class="mb-3">
 <label class="form-label">Have you resigned from the government service during the three (3)-month period before the last election
    ...
    <input type="text" id="details8" name="details8" class="form-control mt-2" placeholder="Provide details"
           vvalue="<?= htmlspecialchars($details8) ?>" />
</div>
...
document.addEventListener("DOMContentLoaded", function() {
    toggleDetails8();
           ...
           <div class="mb-3">
 <label class="form-label">Have you acquired the status of an immigrant or permanent resident of another country?</label>
 <select class="form-select" id="q9" name="q9" onchange="toggleDetails9()">
    ...
    <input type="text" id="details9" name="details9" class="form-control mt-2" placeholder="Provide details"
...
document.addEventListener("DOMContentLoaded", function() {
    toggleDetails9();
                            ...
                            <div class="mb-3">
  <label class="form-label">Pursuant to: (a) Indigenous People's Act (RA 8371); (b) Magna Carta for Disabled Persons (RA 7277); and
                            (c) Solo Parents Welfare Act of 2000 (RA 8972), please answer the following items:'</label>
    ...
    <input type="text" id="details10" name="details10" class="form-control mt-2" placeholder="Provide details"
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    <input type="text" id="details11" name="details11" class="form-control mt-2" placeholder="Provide details"
...
document.addEventListener("DOMContentLoaded", function() {
   ...
   <select class="form-select" id="q12" name="q12" onchange="toggleDetails12()">
    ...
    <input type="text" id="details12" name="details12" class="form-control mt-2" placeholder="Provide details"
...
<div id="referenceContainer">
        ...
        <?php foreach ($reference_data as $index => $ref): ?>
            <div class="mb-3 row reference-item">
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control" name="refName1[]" value="<?= htmlspecialchars($ref['refName1'] ?? '') ?>" placeholder="Enter Name">
                </div>
                <div class="col-md-4">
                    <label class="form-label">Address</label>
                    <input type="text" class="form-control" name="refAddress1[]" value="<?= htmlspecialchars($ref['refAddress1'] ?? '') ?>" placeholder="Enter Address">
                </div>
                <div class="col-md-4">
                    <label class="form-label">Phone Number</label>
                    <input type="text" class="form-control" name="refPhone1[]" value="<?= htmlspecialchars($ref['refPhone1'] ?? '') ?>" placeholder="Enter Phone Number">
                </div>
            </div>
        <?php endforeach; ?>
    <?php else: ?>
    ...
    <button type="button" class="custom-outline-blue" onclick="addReference()">+ Add Reference</button>
        ...
        function addReference() {
          if (refCount >= refC){
            ...
            container.appendChild(newRow);
                        ...
                        <div class="mt-2">
                        <button type="button" class="btn btn-primary me-2" name="save" id="save" style="background-color: #007bff; border-color: #007bff; position:relative; top:-20px; left:10px;" >Save</button>
                             

                            <button type="submit" class="btn btn-outline-secondary" name="download_excel" id="download_excel" style="background-color: #3CB371; border-color: #3CB371; color: white; position:relative; left:10px; top: -20px;">Download as Excel</button>
                        </div>
                   </form>
                    </div>
                    <!-- /Account -->
